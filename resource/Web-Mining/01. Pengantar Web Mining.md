...
> Dikonversi otomatis dari `resource/Web-Mining/01. Pengantar Web Mining.ppt`.
...
- Taxonomy Web Mining
- ![Diagram taksonomi web mining](./lecture-1-assets/slide09-taxonomi-web-mining.png)
...
## Slide 15: Ekstraksi Informasi

**Isi slide:**

- ![Contoh tabel produk](./lecture-1-assets/slide15-tabel-contoh-produk.png)
- Contoh
...
- ![Diagram alur clickstream](./lecture-1-assets/slide17-diagram-clickstream.png)
- Source:  Turban et al. (2011), Decision Support and Business Intelligence Systems
...
- ![Proses Web Usage Mining](./lecture-1-assets/slide18-proses-web-usage-mining.png)
...
- ![Graf jaringan sosial](./lecture-1-assets/slide22-graf-jaringan-sosial.png)
- ?
- ?
- ?
- Centrality
...
- ![Contoh deteksi centrality](./lecture-1-assets/slide22-contoh-centrality.png)
...
- ![Visualisasi komunitas 1](./lecture-1-assets/slide24-graf-komunitas-1.png)
- ![Visualisasi komunitas 2](./lecture-1-assets/slide24-graf-komunitas-2.png)
...
- ![Web mining antar bidang ilmu](./lecture-1-assets/slide25-web-mining-antar-bidang.png)
...
- ![Proses web mining](./lecture-1-assets/slide26-proses-web-mining.png)
- ![Tahapan proses 1](./lecture-1-assets/slide26-tahapan-proses-1.png)
- Gathered
- ![Tahapan proses 2](./lecture-1-assets/slide26-tahapan-proses-2.png)
...
Visualasisasi data
- ![Gathering & exploration 1](./lecture-1-assets/slide27-gathering-exploration-1.png)
- ![Gathering & exploration 2](./lecture-1-assets/slide27-gathering-exploration-2.png)
- Universität Mannheim – Bizer/Ponzetto/Peeters/Takeshita: Web Mining – FSS2025 (Version: 10.2.2025) – Slide
...
- Actual Data Mining
- ![Actual data mining](./lecture-1-assets/slide29-actual-data-mining.png)
